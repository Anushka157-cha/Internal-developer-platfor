...
export class ServicesController {
  ...
  @Get()
  findAll(
    @Query('environment') environment?: ServiceEnvironment,
    @Query('healthStatus') healthStatus?: ServiceHealthStatus,
  ) {
    return this.servicesService.findAll({ environment, healthStatus });
  }
